...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function fetchEstados() {
    return fetch('/buscar_estados_por_tipo_clinica/?tipo_clinica=Emergência')
  ...
  function fetchCidades(estado) {
    return fetch(`/buscar_cidades_por_tipo_clinica/?tipo_clinica=Emergência&estados=${estado}`)
    .then(response => response.json())
    .then(data => {
